...
/**
 * Make a URL string is a posterdate.com URL
 */
export default url => {
	...
	try {
		...
		// hostname might be posterdate.com or subdomain.posterdate.com, so we use .endsWith
		// We don't just check .contains because otherwise folks could make posterdate.com.mydomain.com
		...
		// Make sure the passed redirect URL is a posterdate.com one or (in development) localhost
